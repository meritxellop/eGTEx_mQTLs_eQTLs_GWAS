...
res=read.table('output/Chmm/summary.Chmm.active_states.txt',header=T)
res$yi=res$logOR
res$vi=NA
res$sei=NA
...
write.table(file='output/Chmm/meta.summary.Chmm.active_states.txt',res_summary_all,quote=F,row.names=F,col.names=T,sep='\t')
