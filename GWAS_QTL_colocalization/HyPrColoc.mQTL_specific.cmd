...
$wdir/scripts/HyPrColoc.mQTL_specific.R --cpg $cpg --tissue $tissue --gwas $gwas --gwasr $gwasr  --sample_size $ss --cases $cases --type $type --p1 $p1 --p2 $p2 --eQTLtrait \$eQTLtrait --coloc_category $mQTL_coloc_category
done
