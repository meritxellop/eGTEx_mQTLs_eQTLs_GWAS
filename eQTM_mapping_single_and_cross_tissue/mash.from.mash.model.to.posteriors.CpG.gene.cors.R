...
load('mash_output/CpG.gene.cors.mash.mixture.model.Robj')
...
CpG.gene.cors.m2 = mash(mash_data, g=get_fitted_g(mash.model), fixg=TRUE)
#eQTLs.m2 = mash_compute_posterior_matrices(mash.model, mash_data)
save(file='mash_output/CpG.gene.cors.mash.output.Robj',CpG.gene.cors.m2)
quit(save='no')
